...
('Howto.Admin', 0, 'Administer posts', NULL, 'N;'),
('Howto.Create', 0, 'Create posts', NULL, 'N;'),
('Howto.Delete', 0, 'Delete posts', NULL, 'N;'),
('Howto.Update', 0, 'Update posts', NULL, 'N;'),
('Howto.View', 0, 'View posts', NULL, 'N;'),
...
('Authenticated', 'Guest'),
('PostAdministrator', 'Howto.Admin'),
('Authenticated', 'Howto.Create'),
('PostAdministrator', 'Howto.Create'),
('PostAdministrator', 'Howto.Delete'),
('PostAdministrator', 'Howto.Update'),
('Guest', 'Howto.View'),
('PostAdministrator', 'Howto.*'),

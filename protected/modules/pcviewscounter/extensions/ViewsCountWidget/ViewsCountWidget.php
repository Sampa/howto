...
class ViewsCountWidget extends CWidget {
	...
	const COOKIE_ENCRYPT_KEY = "allahaeidd646dloid0+9476014760dieuoeiuoeidtpygddeaiaöydanedi.wediaei";
	...
	public function init() {
		...
		$this->_clientIpAddress = Yii::app()->request->userHostAddress;
	...
	public function run() {
		...
		if ($this->_mainMode == 'render') {
			...
			$impression_url = Yii::app()->createUrl('pcviewscounter/ViewsCounterProcessor/impressMe',

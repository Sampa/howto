...
<style type='text/css'>#copyMenu li span, #closeFrame {background-image:url(<?=$baseUrl;?>/images/icons.gif);}</style>
<script type='text/javascript'>var wpMoviePath = '<?=$baseUrl;?>/js/ZeroClipboard.swf';</script>
	<ul id='copyMenu' class='ampSwitch pageSlide'> 
      ...
      <li id='outlook' class='long' title='mailto:?subject=Check this out:[title]%22&amp;body=[text]%22...%0D%0D-- [url]'><span>Outlook</span></li> 

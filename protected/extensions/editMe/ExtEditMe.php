...
class ExtEditMe extends CInputWidget {
	 ...
	 */
	public $contentsCss = array('css/main.css');
	 ...
	 */
	public $filebrowserBrowseUrl = 'files/';
	 ...
	 */
	public $filebrowserImageBrowseUrl = 'images/originals';
	 ...
	 */
	public $filebrowserUploadUrl = 'files/';
	 ...
	 */
	public $filebrowserImageUploadUrl = 'images/originals';
	 ...
	 */
	public $toolbar = array(array('Save',
		 'Cut','Copy','Paste','Undo','Redo','BidiLtr','BidiRtl','JustifyLeft',
		 'JustifyCenter','JustifyRight','JustifyBlock',
		 'Find','Replace','SelectAll',
		 'Image','Table','HorizontalRule','Smiley','SpecialChar',
		 'Styles','Template','Print','Flash','Anchor','TextDirection',
